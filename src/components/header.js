    ...
    <div>
        <div className="header" style={{position: pos, mixBlendMode: "normal"}}>
            ...
            <div className="header-text" style ={{display: "flex", flexDirection: "column", alignItems: "right", textAlign:"right"}}>
              ...
              <p style={{width: "100%"}}>is a PhD student @ Harvard researching accessible, ethical tech. <br></br>creating with expansive love + community care. <a href='/philosophy'>design philosophy <span style={{fontFamily: "Vengeance", fontSize: "1rem", color: "rgba(255, 120, 172)"}}>{'\u2197'}</span></a></p>
            </div>
        </div>
    </div>
  );

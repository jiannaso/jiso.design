...
import closeted from '../media/closeted.MP4';
...
function Playground() {
    ...
    return (
        <div className="playground" style={{position: "absolute", top: "0", left: "0", width: "100vw", height: "200vh", overflow: "hidden", zIndex: "0"}}>
            <Box title={"Health Tech for Older Adults"} topx={"50vh"} lefty={"50vw"} widthx={small} heighty={small} url ={'flower.jpeg'}/>
            <Box title={"Patient-centered Digital Phenotyping"} topx={"60vh"} lefty={"70vw"} widthx={large} heighty={large}/>
            <Box title={"Projection art"} topx={"40vh"} lefty={"65vw"} widthx={large} heighty={large} url={closeted}/>
            <Box title={"Interactive Knit Patterns"} topx={"30vh"} lefty={"30vw"} widthx={small} heighty={small} url={knit}/>
            <Box title={"Paghalo"} topx={"20vh"} lefty={"60vw"} widthx={small} heighty={small} url ={paghalo}/>

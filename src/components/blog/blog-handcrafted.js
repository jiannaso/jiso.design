    ...
    <div className="App">
      ...
      <div className="blog-container">
        ...
        <p>
          ...
          <p id="left">
          welcome to my website of 2025, using fonts and images by filipino designers (Vengeance font by <a href='https://allicunanan.gumroad.com/'>Alli Cunanan</a>) 🌸 

          <br></br> <br></br> 

i secretly redo my portfolio twice a year, exploring it as a creative playground instead of corporate performance. there is no “vibe coding”— i speak poems to my code editor, defining each data point and pixel by hand, and it brings my visions to life. <br></br> <br></br> 
